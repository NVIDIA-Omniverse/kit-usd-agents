...
"""Settings service for managing Isaac Sim settings data with FAISS search."""
...
SETTINGS_DATA_BASE = Path(__file__).parent.parent / "data" / ISAACSIM_VERSION / "settings"
...
class SettingsService:
    """Service for managing Isaac Sim settings information with FAISS search."""
