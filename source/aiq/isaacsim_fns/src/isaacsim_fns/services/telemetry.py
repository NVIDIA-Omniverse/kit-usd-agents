...
"""
Centralized telemetry service for Isaac Sim MCP using Redis Streams.
"""
...
class TelemetryService:
    ...
    REDIS_HOST = os.getenv("ISAACSIM_MCP_REDIS_HOST", "localhost")
    REDIS_PORT = int(os.getenv("ISAACSIM_MCP_REDIS_PORT", "6379"))
    KEY_PREFIX = os.getenv("ISAACSIM_MCP_TELEMETRY_PREFIX", "isaacsim_mcp:telemetry")
    ...
    async def capture_call(
        ...
        try:
            ...
            # Format: isaacsim_mcp:telemetry:YYYY-MM-DD:HH-MM-SS-microseconds:call_id
