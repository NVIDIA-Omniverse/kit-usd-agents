...
"""Function to search for Isaac Sim extensions using semantic search."""
...
async def search_extensions(query: str, top_k: int = 20) -> Dict[str, Any]:
    ...
    try:
        logger.info(f"Searching Isaac Sim extensions with query: '{query}'")
        ...
        # Format the results
        result_lines = [f"# Isaac Sim Extension Search Results for: '{query}'"]
