...
"""Function to retrieve detailed Isaac Sim extension information."""
...
async def get_extension_details(extension_ids) -> Dict[str, Any]:
    """Get detailed information about one or more Isaac Sim extensions.
    ...
    try:
        ...
        logger.info(f"Retrieving detailed info for {len(extension_ids)} Isaac Sim extension(s): {extension_ids}")
