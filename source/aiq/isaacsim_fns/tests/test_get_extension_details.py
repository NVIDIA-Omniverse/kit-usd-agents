...
from isaacsim_fns.functions.get_extension_details import get_extension_details
from isaacsim_fns.services.extension_service import ExtensionService
...
async def run_tests():
    ...
    with (
        patch("isaacsim_fns.functions.get_extension_details.get_extension_service", return_value=mock_service),
        patch(
            "isaacsim_fns.functions.get_extension_details.ensure_telemetry_initialized",
            side_effect=mock_ensure_telemetry_initialized,
        ),
        patch("isaacsim_fns.functions.get_extension_details.telemetry", mock_telemetry),
    ):
